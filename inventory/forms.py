...
from school_setting.models import SessionModel, TermModel
...
class SaleForm(forms.ModelForm):
    ...
    # OLD METHOD in SaleForm
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        # This line will cause an error
        self.fields['customer'].queryset = StudentsModel.objects.filter(is_active=True).select_related(
