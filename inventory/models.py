...
class InventoryAssignmentModel(models.Model):
    ...
    # Who gets it
    student_classes = models.ManyToManyField('academic.ClassesModel', blank=True)
...
class InventoryCollectionModel(models.Model):
    ...
    student = models.ForeignKey(StudentsModel, on_delete=models.CASCADE, related_name='inventory_collections')
    # Collection details
...
class SaleModel(models.Model):
    ...
    customer = models.ForeignKey(StudentsModel, on_delete=models.SET_NULL, null=True, blank=True)
...
class DirectSaleModel(models.Model):
    ...
    # Who and what
    student = models.ForeignKey(StudentsModel, on_delete=models.CASCADE, related_name='direct_purchases')
