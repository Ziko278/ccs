...
class StudentFundingModel(models.Model):
    ...
    student = models.ForeignKey(StudentsModel, on_delete=models.CASCADE, related_name='funding_list')
...
class InvoiceModel(models.Model):
    ...
    student = models.ForeignKey(StudentsModel, on_delete=models.PROTECT, related_name='invoices')
...
class FeePaymentModel(models.Model):
    ...
    currency = models.CharField(max_length=20, choices=Currency.choices, blank=True, default='naira')
...
class OtherPaymentModel(models.Model):
    ...
    student = models.ForeignKey(StudentsModel, on_delete=models.PROTECT, related_name='other_debts')
...
class SalaryRecord(models.Model):
    ...
    salary_structure = models.ForeignKey(SalaryStructure, on_delete=models.PROTECT, related_name='salary_records', blank=True, null=True)
    salary_setting = models.ForeignKey(SalarySetting, on_delete=models.PROTECT, related_name='salary_records', blank=True, null=True)
