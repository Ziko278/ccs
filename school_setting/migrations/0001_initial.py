    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.FileField(blank=True, storage=admin_dashboard.storage_backends.MediaStorage(), upload_to='images/logo')),
        ...
        migrations.AddField(
            model_name='schoolacademicinfomodel',
            name='term',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='school_setting.termmodel'),
        ),
    ]
